...
static esp_netif_t *wifi_helper_netif = NULL;
static esp_event_handler_instance_t ip_event_handler;
static esp_event_handler_instance_t wifi_event_handler;
static wifi_event_callback_t on_got_ip_callback = NULL;
...
esp_err_t wifi_helper_init(void)
{
    ...
    wifi_helper_netif = esp_netif_create_default_wifi_sta();
    if (wifi_helper_netif == NULL) {
...
esp_err_t wifi_helper_deinit(void)
{
    ...
    ESP_ERROR_CHECK(esp_wifi_clear_default_wifi_driver_and_handlers(wifi_helper_netif));
    esp_netif_destroy(wifi_helper_netif);
